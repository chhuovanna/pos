...
*/
    ...
    protected function setFieldValue($id)
    {
        ...
        $this->builder->fields()->each(function (Field $field) use ($data) {
            ...
            //added by vanna to diasable the change of state of a current exchange rate
            
          /*  if ($field->column() == 'currentrate'){
    ...
    public function resource($slice = -2)
    {
        ...
        if (array_slice($segments, -1)[0] && array_slice($segments, -2)[0] == 'create' && array_slice($segments, -3)[0] == 'inventory'){
