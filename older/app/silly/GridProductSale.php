...
use Encore\Admin\Grid\Displayers\ActionsProductSale;
...
class GridProductSale extends Grid
{
    ...
    {
        $this->filter = new FilterProduct($this->model());
    }
    ...
    protected function appendActionsColumn()
    {
        ...
        $column->display(function ($value) use ($grid, $column, $callback) {
            ...
            $actions = new ActionsProductSale($value, $grid, $column, $this);
